 ...
 *
 */
public class SecondaryNodeMain {
	...
	public static void main(String[] args) {
		...
		while (isLaunched == false) {
			...
			switch(option) {
			case 1:
				config.createSecondaryNode();
				break;
			case 2:
				config.initSecondaryNode();
				break;
			case 3:
				isLaunched = config.launchBlockchainWithSecondaryNode();
				break;
			default: 
